...
const NetworkMonitor = () => {
  ...
  useEffect(() => {
    if (isMonitoring) {
      const savedPacketCount = localStorage.getItem(
        "networkMonitor_packetCount"
      );
      const savedBytesTransferred = localStorage.getItem(
        "networkMonitor_bytesTransferred"
      );

      if (savedPacketCount) {
        setPacketCount(parseInt(savedPacketCount, 10));
      }

      if (savedBytesTransferred) {
        setBytesTransferred(parseInt(savedBytesTransferred, 10));
      }
    }
  }, [isMonitoring]);
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setBytesTransferred((prev) => {
        const newValue =
          prev + networkStats.bytesPerSecond * 1024 * 1024;
  ...
  const currentThroughput = networkStats.bytesPerSecond;
    ...
    <div className="space-y-6">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="eth0">
                    eth0 - Ethernet (Primary)
                  </SelectItem>
                  <SelectItem value="wlan0">
                    wlan0 - WiFi
                  </SelectItem>
                  <SelectItem value="lo">
                    lo - Loopback
                  </SelectItem>
                  <SelectItem value="docker0">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
            ...
            <div className="text-center">
              <p className="text-2xl font-bold text-green-600">
                {(bytesTransferred / 1024 / 1024).toFixed(1)}M
              </p>
              <p className="text-xs text-muted-foreground">
                Bytes Captured
              </p>
            ...
            <div className="text-center">
              <p className="text-2xl font-bold text-green-600">
                {networkStats.allowedPackets.toLocaleString()}
              </p>
              <p className="text-xs text-muted-foreground">
                Allowed
              </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Network traffic in MB/s over time
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Network traffic by protocol type
            </CardDescription>
          </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Most active IP addresses by packet count
          </CardDescription>
        </CardHeader>
